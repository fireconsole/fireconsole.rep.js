...
function impl(domplate) {
  ...
  return {
    ...
    postRender: function postRender(node) {
      ...
      if (typeof node.messageObject.meta.keeptitle !== "undefined") {
        node.setAttribute("keeptitle", node.messageObject.meta.keeptitle ? "true" : "false");
      } else if (node.messageObject && _typeof(node.messageObject.postRender) == "object") {
...
var __loop__ = context.__loop__;
var __link__ = context.__link__;
return (function (__code__, __context__, __in__, __out__) {  with (this) {  with (__in__) {    __code__.push("","<div", " __dbid=\"","17666bfebba6b6281f2f6528788352d53723cd09", "\"", " __dtid=\"","insight.domplate.reps/wrappers/console", "\"", " class=\"","group-no-messages", " ", "\"",">","No Messages","</div>");  }}})
}
};
  rep.__dbid = "17666bfebba6b6281f2f6528788352d53723cd09";
