...
var __loop__ = context.__loop__;
var __link__ = context.__link__;
return (function (__code__, __context__, __in__, __out__) {  with (this) {  with (__in__) {    __code__.push("","<span", " __dbid=\"","04d5d1517ea7e97aa1e2e5f1d90c269d9898d4ea", "\"", " __dtid=\"","insight.domplate.reps/default/trace", "\"", " class=\"","structures-trace", " ", "\"",">");__link__(getCaptionTag(context,node), __code__, __out__, {"node":getCaptionNode(node)});    __code__.push("","</span>");  }}})
}
};
  rep.__dbid = "04d5d1517ea7e97aa1e2e5f1d90c269d9898d4ea";
